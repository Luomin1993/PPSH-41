...
//     Polynomial fx;
// 
//     Monomial ARR_MONOMIALS[3] = {m1,m2,m3};
//     int16_t ARR_MONOMIALS_COEFF[3] = {1,1,1};
//     int16_t DIM_MONOMIALS = 3;
// 
//     Polynomial_make(&fx, &f1, ARR_MONOMIALS, ARR_MONOMIALS_COEFF, DIM_MONOMIALS);
// 
//     printf("Polynomial fx =%s, VALUE=%d\n", Polynomial_getPolynomial(&fx), Polynomial_getPolynomialValue(&fx)); 
// 
//     return 0;
// }
...
int main() 
{
    ...
    Monomial m2;
    int16_t ARR_COEFF_2[3] = {1,1,0};
    int16_t ARR_POWER_2[3] = {1,1,0};
    Monomial_make(&m2, ARR_SYMBOLS, ARR_COEFF_2,ARR_POWER_2, 3);

    Monomial m3;
    Monomial_optProduct(&m1,&m2,&m3);
    printf("Monomial m3 =%s, VALUE=%d\n", Monomial_getMonomial(&m3), Monomial_getMonomialValue(&m3)); 
